  ...
  return ( 
    ...
    <footer >
      <div className="container">
          <nav className="footer" style={{padding: '0%'}}>
                <a className="a-footer" target="_self" href="https://www.linkedin.com/in/joelgomezok/">
                ...
                <a className="a-footer" target="_self" href="https://github.com/joelgomezok">
