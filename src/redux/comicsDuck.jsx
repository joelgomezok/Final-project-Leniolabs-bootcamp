...
export const getComicsAction = (id) => async (dispatch) => {
       ...
       // const BaseURL = 'https://gateway.marvel.com:443/v1/public/characters/';
        ...
        const ComicsURL = `https://gateway.marvel.com:443/v1/public/characters/${characterId}/comics?orderBy=onsaleDate&ts=1&apikey=6658de89c9628f0521d5a33849d853e5&hash=${Hash}`; //puedefallar elbaseURL 
        try {
